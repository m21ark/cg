...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.watermap = new CGFtexture(this, "textures/waterMap2.jpg");
		...
		this.testShaders = [
			new CGFshader(this.gl, "shaders/kiev.vert", "shaders/kiev.frag"),
	...
	update(t) {
		...
		if (this.selectedExampleShader == 11)
			this.testShaders[11].setUniformsValues({ timeFactor: t / 300 % 100 });
	}
