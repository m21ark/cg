...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.prism = new MyPrism(this, 8, 20, 1 / 20);
        this.cylinder = new MyCylinder(this, 8, 20, 1/20)

        this.tangram = new MyTangram(this)
        this.cube = new MyUnitCube(this)

        this.globalIluminationIntensity = 0.8;

        this.objects = [this.cylinder, this.pyramid, this.cone, this.cube, this.plane, this.tangram, this.prism];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Cylinder': 0, 'Pyramid': 1, 'Cone': 2, 'Cube': 3, 'Plane': 4, 'Tangram': 5, 'Prism': 6 };
    ...
    initLights() {
        ...
        this.lights[1].setPosition(-5.0, -1, 0.0, 1.0);
    ...
    initCameras() {
        this.camera = new CGFcamera(1.5, 0.1, 500, vec3.fromValues(10, 10, 10), vec3.fromValues(0, 0, 0));
    }
    ...
    initMaterials() {
        ...
        // this.material1.setEmission(0, 0, 0, 1.0);
        ...
        this.materials = [this.material4, this.material2, this.material3, this.material1, this.customMaterial];

        // Labels and ID's for object selection on MyInterface
        this.materialIDs = { 'Wood': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Red AMbient': 3, 'Custom': 4 };
    }
    display() {
        // ---- BEGIN Background, camera and axis setup
        // Clear image and depth buffer everytime we update the scene
        this.setGlobalAmbientLight(this.globalIluminationIntensity, this.globalIluminationIntensity, this.globalIluminationIntensity, 1.0);
